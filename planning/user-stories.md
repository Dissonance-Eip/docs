---
title: User stories and workflows
status: final
owner: Noé Kurata
created: 2026-02-20
updated: 2026-09-04
milestone: A
tags: [planning, personas, user-stories]
---
...
**References**
- Personas: [`../research/personas/`](../research/personas/)
- Planning: [`milestones.md`](milestones.md) and [`roadmap.md`](roadmap.md)

## Personas (source docs)

- [Music Label Executive](../research/personas/music-label-executive.md)
- [Independent Musician](../research/personas/independent-musician.md)
- [Audio Engineer / Studio Producer](../research/personas/audio-engineer.md)
- [Music Enthusiast / AI User](../research/personas/music-enthusiast-ai-user.md)
- [Academic Researcher (AI & Audio)](../research/personas/academic-researcher.md)
