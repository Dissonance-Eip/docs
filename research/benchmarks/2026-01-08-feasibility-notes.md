---
title: Feasibility notes — adversarial audio, from external research
status: final
owner: Noé Kurata
created: 2026-01-08
updated: 2026-09-04
milestone: B
tags: [research, feasibility, dsp]
---

# Feasibility notes — adversarial audio, from external research

## Summary

A close reading of Benn Jordan's "The Art of Poison-Pilling Music Files" as a
feasibility benchmark for Dissonance: what the video demonstrates, the
mathematics behind it, where it parallels the Dissonance pipeline, and where it
stops short of what this project needs to prove. The conclusion is that the
approach is feasible — the video shows measurable degradation of AI transcription
on perturbed audio — while the perturbation families, the robustness evaluation
and the formal perception study remain Dissonance's own work.
