...
The earlier document `research/benchmarks/2025-11-21-Dissonance_Full_Electron_Study.md` explains why the project chose an Electron plus TypeScript architecture instead of a JUCE or pure C++ UI stack. That study covers trade offs around performance, customization, design system support, and long term maintainability.
